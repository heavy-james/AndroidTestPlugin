...
public class LogUtil {
    ...
    private static final String TAG = "AndroidTestDSL";
    ...
    public static void v(String tag, String content) {
        ...
        if (canPrint(LEVEL_VERBOSE)) {
            Log.print(actionInfo.toString());
        }
        if (mSaveLog) {
            Writer.recordActionInfoLog(actionInfo);
        }
    }

    public static void d(String tag, String content) {
        ActionInfo actionInfo = new ActionInfo("DEBUG", TAG, "[" + tag + "]:" + content);
    ...
    public static void i(String tag, String content) {
        ActionInfo actionInfo = new ActionInfo("INFO", TAG, "[" + tag + "]:" + content);
    ...
    public static void w(String tag, String content) {
        ActionInfo actionInfo = new ActionInfo("WARN", TAG, "[" + tag + "]:" + content);
    ...
    public static void e(String tag, String content) {
        ActionInfo actionInfo = new ActionInfo("ERROR", TAG, "[" + tag + "]:" + content);
